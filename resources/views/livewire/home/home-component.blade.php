        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-7 d-lg-block">
                <div class="hero-1-thumb-15 wow fadeInUp animated" data-wow-delay="0.4s">
                    <img class="img-fluid wow fadeInRight animated" src="{{ asset('assets/images/hero/hero-1.png') }}" alt="hero-1">
                </div>
            </div>
            <!-- /col -->
        </div>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-6 align-self-center">
                <div class="mb-20">
                    <img src="{{ asset('assets/images/bg/about.png') }}" class="img-fluid  wow fadeInLeft animated" data-wow-delay="0.2s"
                         alt="image">
                </div>
            </div>
            <!-- /col -->
            ...
            <div class="col-lg-6">
                <div class="about-content warp">
                    ...
                    <div class="about-btn justify-content-center text-center">
                        <a href="{{route('about')}}" class="btn theme-btn-1">
                            Learn More
                        </a>
                    </div>
                </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="single-services-item">
                    <div class="image">
                        <a href="#">
                            <img src="{{ asset('assets/images/services/001.jpg') }}" alt="image">
                        </a>
                    </div>
                    <div class="content">
                        <h3>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="single-services-item">
                    <div class="image">
                        <a href="#">
                            <img src="{{ asset('assets/images/services/002.jpg') }}" alt="image">
                        </a>
                    </div>
                    <div class="content">
                        <h3>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="single-services-item">
                    <div class="image">
                        <a href="#">
                            <img src="{{ asset('assets/images/services/003.jpg') }}" alt="image">
                        </a>
                    </div>
                    <div class="content">
                        <h3>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="single-services-item">
                    <div class="image">
                        <a href="#">
                            <img src="{{ asset('assets/images/services/004.jpg') }}" alt="image">
                        </a>
                    </div>
                    <div class="content">
                        <h3>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="single-services-item">
                    <div class="image">
                        <a href="#">
                            <img src="{{ asset('assets/images/services/005.jpg') }}" alt="image">
                        </a>
                    </div>
                    <div class="content">
                        <h3>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="single-services-item">
                    <div class="image">
                        <a href="#">
                            <img src="{{ asset('assets/images/services/006.jpg') }}" alt="image">
                        </a>
                    </div>
                    <div class="content">
                        <h3>
                ...
                <div class="testimonial-item-wrap-1 testimonial-carousel-1">
                    <div class="testimonial-item">
                        <div class="testimonial-author">
                            <img src="{{ asset('assets/images/testimonial/03.jpg') }}" alt="small-avatar">
                    ...
                    <div class="testimonial-item">
                        <div class="testimonial-author">
                            <img src="{{ asset('assets/images/testimonial/02.jpg') }}" alt="small-avatar">
                    ...
                    <div class="testimonial-item">
                        <div class="testimonial-author">
                            <img src="{{ asset('assets/images/testimonial/05.jpg') }}" alt="small-avatar">
                    ...
                    <div class="testimonial-item">
                        <div class="testimonial-author">
                            <img src="{{ asset('assets/images/testimonial/04.jpg') }}" alt="small-avatar">
                    ...
                    <div class="testimonial-item">
                        <div class="testimonial-author">
                            <img src="{{ asset('assets/images/testimonial/06.jpg') }}" alt="small-avatar">
                    ...
                    <div class="testimonial-item">
                        <div class="testimonial-author">
                            <img src="{{ asset('assets/images/testimonial/01.jpg') }}" alt="small-avatar">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6">
                <div class="why-choose-us-img">
                    <img src="{{ asset('assets/images/bg/choose-us.png') }}" alt="Image">
                </div>
            </div>
            <!-- /col -->
            <!-- col -->
        ...
        <div class="row align-items-center justify-content-between">
                ...
                <div class="download-1-content mt-50">
                    ...
                    <div class="mt-4 wow fadeInUp animated" data-wow-delay="0.6s">
                        <a href="#" class="btn theme-btn-1">
                            <img src="{{ asset('assets/images/svg/android.svg') }}" alt="">
                        </a>
                        <a href="#" class="btn theme-btn-1">
                            <img src="{{ asset('assets/images/svg/apple.svg') }}" alt="">
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xl-5 col-lg-6 col-md-6">
                <div class="download-1-img">
                    <img class=" img-fluid" src="{{ asset('assets/images/bg/download.png') }}" alt="">
                </div>
            </div>
            <!-- /col -->
        </div>
        ...
        <div class="row">
            ...
            <div class="col-xl-4 col-lg-4 col-md-6">
                <div class="blog-wrapper mb-30">
                    <div class="blog-img">
                        <a href="blog-single.html"><img src="{{ asset('assets/images/blog/blog1.jpg') }}" alt=""></a>
                    </div>
                    <div class="blog-text">
            ...
            <div class="col-xl-4 col-lg-4 col-md-6">
                <div class="blog-wrapper mb-30">
                    <div class="blog-img">
                        <a href="blog-single.html"><img src="{{ asset('assets/images/blog/blog2.jpg') }}" alt=""></a>
                    </div>
                    <div class="blog-text">
            ...
            <div class="col-xl-4 col-lg-4 col-md-6">
                <div class="blog-wrapper mb-30">
                    <div class="blog-img">
                        <a href="blog-single.html"><img src="{{ asset('assets/images/blog/blog3.jpg') }}" alt=""></a>
                    </div>
                    <div class="blog-text">
                        <h4><a href="blog-single.html">Lorem ipsum dolor sit amet.</a>
                        </h4>
        ...
        <div class="row">
            ...
            <div class="col-xl-2 col-lg-3 col-md-3 col-sm-6 col-6 text-center">
                <div class="client-logo">
                    <div class="client-logo-img"> <img src="{{ asset('assets/images/client-logo/logo-envato.png') }}" alt=""
                                                       class="img-fluid"></div>
                </div>
            </div>
            <!-- /col -->
            ...
            <div class="col-xl-2 col-lg-3 col-md-3 col-sm-6 col-6 text-center">
                <div class="client-logo">
                    <div class="client-logo-img"> <img src="{{ asset('assets/images/client-logo/logo-converkit.png') }}" alt=""
                                                       class="img-fluid"></div>
                </div>
            </div>
            <!-- /col -->
            ...
            <div class="col-xl-2 col-lg-3 col-md-3 col-sm-6 col-6 text-center">
                <div class="client-logo">
                    <div class="client-logo-img"> <img src="{{ asset('assets/images/client-logo/logo-buzzumo.png') }}" alt=""
                                                       class="img-fluid"></div>
                </div>
            </div>
            <!-- /col -->
            ...
            <div class="col-xl-2 col-lg-3 col-md-3 col-sm-6 col-6 text-center">
                <div class="client-logo">
                    <div class="client-logo-img"> <img src="{{ asset('assets/images/client-logo/logo-buffer.png') }}" alt=""
                                                       class="img-fluid">
                    </div>
                </div>
            </div>
            ...
            <div class="col-xl-2 col-lg-3 col-md-3 col-sm-6 col-6 text-center">
                <div class="client-logo">
                    <div class="client-logo-img"> <img src="{{ asset('assets/images/client-logo/logo-frame.png') }}" alt=""
                                                       class="img-fluid"></div>
                </div>
            </div>
            <!-- /col -->
            ...
            <div class="col-xl-2 col-lg-3 col-md-3 col-sm-6 col-6 text-center">
                <div class="client-logo">
                    <div class="client-logo-img"> <img src="{{ asset('assets/images/client-logo/logo-clearbit.png') }}" alt=""
                                                       class="img-fluid">
                    </div>
                </div>
            </div>
