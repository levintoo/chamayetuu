                                ...
                                <div class="auth-content my-auto">
                                    ...
                                    <form class="mt-4 pt-2" method="POST" action="{{route('login')}}">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control" id="" placeholder="Enter email" type="email" name="email" :value="old('email')" required autofocus >
                                        </div>
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group auth-pass-inputgroup">
                                                <input type="password" class="form-control" placeholder="Enter password" aria-label="Password" aria-describedby="password-addon" name="password" required autocomplete="current-password" >
