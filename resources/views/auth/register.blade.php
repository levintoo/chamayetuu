    ...
    <x-jet-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mt-4">
                ...
                <x-jet-input id="national_id" class="block mt-1 w-full" type="number" name="national_id" :value="old('national_id')" required />
            </div>
            ...
            <div class="mt-4">
                ...
                <x-jet-input id="residence" class="block mt-1 w-full" type="text" name="residence" :value="old('residence')" required />
            </div>
