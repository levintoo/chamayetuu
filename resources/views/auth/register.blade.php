                                ...
                                <div class="auth-content my-auto">
                                    ...
                                    <form class="needs-validation mt-4 pt-2" novalidate method="POST" action="{{ route('register') }}">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="email" class="form-control" id="useremail" placeholder="Enter email" required type="email" name="email" :value="old('email')" required >
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="username" placeholder="Enter name" required name="name" :value="old('name')" required autofocus autocomplete="name">
                                            <div class="invalid-feedback">
                                                Please Enter Name
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="residence" placeholder="Enter residence" required name="residence" :value="old('residence')" required autofocus autocomplete="residence">
                                            <div class="invalid-feedback">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control" id="national_id" placeholder="Enter national id" required name="national_id" :value="old('national_id')" required autofocus autocomplete="national_id">
                                            <div class="invalid-feedback">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="phone" placeholder="Enter phone" required name="phone" :value="old('phone')" required autofocus autocomplete="phone">
                                            <div class="invalid-feedback">
                                                Please Enter Phone
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="password" class="form-control" id="userpassword" placeholder="Enter password" required type="password" name="password" required autocomplete="new-password">
                                            <div class="invalid-feedback">
